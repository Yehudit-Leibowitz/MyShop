...
namespace TestProject1
{
    public class UnitUserTest
    {
        ...
        public async Task Login_ValidCredentialsREturnsUser()
        {
            ...
            var mokContext = new Mock<ApiDbToCodeContext>();
        ...
        {
            var user = new User { FirstName = "invalid", LastName = "invalid", UserName = "invalid@example.com", Password = "password@123" };
            var users = new List<User>() { user };
        ...
        {
            var user = new User { UserId = 20, FirstName = "exampleFirstName", LastName = "exampleLasttName" };
            var mockContext = new Mock<ApiDbToCodeContext>();
